...
public class CustomTrashBinSerializer extends JsonSerializer<Trash> {
    @Override
    public void serialize(Trash notes, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
